...
const VERSION = 'edenrise-v128';
const CORE = ['./', './index.html', './brands/edenrise/brand.js', './brands/_example/brand.js', './core/brandkit.js', './core/ots.js', './core/styles.css', './fonts/fonts.css', './core/app.js', './vendor/gsap.min.js', './vendor/ScrollTrigger.min.js', './brands/edenrise/content.js', './data.js', './manifest.json', './favicon.svg', './icon-192.png', './icon-512.png', './og-image.png'];

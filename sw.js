...
const VERSION = 'edenrise-v74';
const CORE = ['./', './index.html', './brands/edenrise/brand.js', './brands/_example/brand.js', './core/brandkit.js', './core/styles.css', './core/app.js', './brands/edenrise/content.js', './data.js', './manifest.json', './favicon.svg', './icon-192.png', './icon-512.png', './og-image.png'];

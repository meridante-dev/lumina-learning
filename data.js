...
const UI = {
  en: {
    ...
    tr_loading:'Loading transcript…', tr_none:'No transcript for this lesson yet.', ask_moments:'From the lessons themselves', ask_no_moments:'Nothing in the lessons matches that yet — try other words, or ask the tutor.',
  ...
  pt: {
    ...
    tr_loading:'A carregar a transcrição…', tr_none:'Ainda não há transcrição para esta lição.', ask_moments:'Das próprias lições', ask_no_moments:'Nada nas lições corresponde a isso — tente outras palavras, ou pergunte ao tutor.',

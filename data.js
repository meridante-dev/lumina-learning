...
const UI = {
  en: {
    ...
    board_all:'Everyone', board_dept:'My department', live_attended:'Attendance counted — enjoy the session!',
    ...
    pwa_t:'Take the academy with you', pwa_b:'Add EdenRise to your home screen — one tap from anywhere, even offline.', pwa_btn:'Install', pwa_ios:'On iPhone: tap Share, then \u201cAdd to Home Screen\u201d.', comm_pin:'Pin', comm_unpin:'Unpin', comm_delete:'Delete', comm_confirm_del:'Delete this post for everyone?', comm_confirm_del_reply:'Delete this reply?', comm_deleted:'Deleted', comm_privacy:'Your progress is stored in your EdenRise account (Firestore, EU) and only you — and EdenRise admins — can see it. Turn nudges on or off anytime in your profile.',
  ...
  pt: {
    ...
    board_all:'Todos', board_dept:'O meu departamento', live_attended:'Presença registada — boa sessão!',

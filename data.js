...
const UI = {
  en: {
    ...
    edu_with:'With', edu_about:'About', edu_your:'Your educator', edu_more:'More from', edu_external:'external trainer', edu_teaches:'Teaches', edu_band_h:'Learn from your team', edu_band_sub:'The people who know it best', edu_avatar:'AI avatar', edu_avatar_note:'This lesson is presented by an AI avatar of the educator, with their consent. The words and the expertise are theirs.', course_one:'course', courses_n:'courses',
  ...
  pt: {
    ...
    edu_with:'Com', edu_about:'Sobre', edu_your:'O seu formador', edu_more:'Mais de', edu_external:'formador externo', edu_teaches:'Ensina', edu_band_h:'Aprenda com a sua equipa', edu_band_sub:'Quem sabe melhor do que ninguém', edu_avatar:'avatar IA', edu_avatar_note:'Esta lição é apresentada por um avatar de IA do formador, com o seu consentimento. As palavras e o saber são dele.', course_one:'curso', courses_n:'cursos',

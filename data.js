...
const UI = {
  ...
  pt: {
    ...
    vcert_btn:'Certificado comprovado', vcert_locked:'O certificado verificado desbloqueia com: conclusão + exercício aplicado + verificação de retenção diferida', hourlog_btn:'Registo de horas', cert_popup:'Permita pop-ups para abrir o certificado', ots_none:'', ots_pending:'Selo temporal pendente', ots_confirmed:'Com selo temporal público · bloco {b}',

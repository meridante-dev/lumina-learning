...
const UI = {
  en: {
    ...
    cov_h:'Does every video end with a question?', cov_module:'Module', cov_none:'No question', cov_ok:'Verified', cov_reel:'Short', cov_sub:'videos have a verified question', cov_unverified:'Unverified', rc_next:'Next', rc_not_quite:'Not quite.', rc_right:'That\u2019s it.', rc_skip:'Skip', reel_h:'Shorts', reel_keep_watching:'Keep watching', reel_none:'No shorts in this library yet.', reel_open:'Open feed', reel_pause_eyebrow:'Take a breath', reel_pause_h:'That is five in a row.', reel_pause_sub:'Shorts are the hook. The hours, and what you can prove, live in the course.', reel_placeholder:'Placeholder — script coming', reel_save:'Save', reel_sound:'Sound',

...
const UI = {
  ...
  pt: {
    ...
    tr_loading:'A carregar a transcrição…', tr_none:'Ainda não há transcrição para esta lição.', ask_moments:'Das próprias lições', recall_recent:'Retomar o que perguntou', link_copy:'Copiar ligação para este momento', link_copied:'Ligação copiada — abre o vídeo neste segundo', tag_at:'Dito aos', ask_speak:'Ler a resposta em voz alta', ask_no_moments:'Nada nas lições corresponde a isso — tente outras palavras, ou pergunte ao tutor.',

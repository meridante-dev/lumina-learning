...
const UI = {
  en: {
    ...
    tutor_name:'EdenRise AI Tutor', tutor_ai_note:'AI assistant — answers can be wrong; verify what matters.', tutor_demo:'● Demo mode · scripted replies', summarize_course:'Summarize this course', quiz_now:'Quiz me now', whats_due:"What's due?", build_path:'Build me a path', ask_anything:'Ask anything about your land or courses…',

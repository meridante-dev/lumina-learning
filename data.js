...
const UI = {
  en: {
    ...
    ob_welcome:'Welcome to EdenRise', ob_step:'Step', ob_q1:'What do you do, João?', ob_q1_sub:'The AI uses your role to seed your first learning path. You can change everything later.', ob_skip:'Skip — explore on my own', ob_continue:'Continue →',
  ...
  pt: {
    ...
    ob_welcome:'Bem-vindo à EdenRise', ob_step:'Passo', ob_q1:'O que faz, João?', ob_q1_sub:'A IA usa a sua função para criar o seu primeiro percurso. Pode mudar tudo mais tarde.', ob_skip:'Ignorar — explorar sozinho', ob_continue:'Continuar →',

...
const UI = {
  en: {
    ...
    tr_loading:'Loading transcript…', tr_none:'No transcript for this lesson yet.', ask_moments:'From the lessons themselves', recall_recent:'Pick up where you asked', tutor_foot_gateway:'AI tutor · answers grounded in your courses · this is an AI, not a person', link_copy:'Copy link to this moment', link_copied:'Link copied — opens the video at this second', tag_at:'Said at', ask_speak:'Read the answer aloud', ask_no_moments:'Nothing in the lessons matches that yet — try other words, or ask the tutor.',
  ...
  pt: {
    ...
    tr_loading:'A carregar a transcrição…', tr_none:'Ainda não há transcrição para esta lição.', ask_moments:'Das próprias lições', recall_recent:'Retomar o que perguntou', tutor_foot_gateway:'Tutor de IA · respostas baseadas nos seus cursos · é uma IA, não uma pessoa', link_copy:'Copiar ligação para este momento', link_copied:'Ligação copiada — abre o vídeo neste segundo', tag_at:'Dito aos', ask_speak:'Ler a resposta em voz alta', ask_no_moments:'Nada nas lições corresponde a isso — tente outras palavras, ou pergunte ao tutor.',

...
const UI = {
  en: {
    ...
    dig_h:'This week at EdenRise', dig_sub:'Two minutes per department — stay connected to the whole.', pwa_t:'Take the academy with you', pwa_b:'Add EdenRise to your home screen — one tap from anywhere, even offline.', pwa_btn:'Install', pwa_ios:'On iPhone: tap Share, then \u201cAdd to Home Screen\u201d.', comm_pin:'Pin', comm_unpin:'Unpin', comm_delete:'Delete', comm_confirm_del:'Delete this post for everyone?', comm_confirm_del_reply:'Delete this reply?', comm_deleted:'Deleted', comm_privacy:'Your progress is stored in your EdenRise account (Firestore, EU) and only you — and EdenRise admins — can see it. Turn nudges on or off anytime in your profile.',
